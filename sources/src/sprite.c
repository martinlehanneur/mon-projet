...
SDL_Surface* banner_bomb1;
SDL_Surface* banner_bomb2;
SDL_Surface* banner_bomb3;
SDL_Surface* banner_bomb4;
...
static void banner_load() {
	...
	banner_bomb1 = load_image(BOMB_TTL1);
	banner_bomb2 = load_image(BOMB_TTL2);
	banner_bomb3 = load_image(BOMB_TTL3);
	banner_bomb4 = load_image(BOMB_TTL4);
...
static void banner_unload() {
	...
	SDL_FreeSurface(banner_bomb1);
	SDL_FreeSurface(banner_bomb2);
	SDL_FreeSurface(banner_bomb3);
	SDL_FreeSurface(banner_bomb4);
...
SDL_Surface* sprite_get_banner_bomb3() {
			assert(banner_bomb3);
			return banner_bomb3;
}
